...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { buyer: @purchase_order.buyer, delivery_date: @purchase_order.delivery_date, grand_total: @purchase_order.grand_total, no: @purchase_order.no, po_date: @purchase_order.po_date, prepared_by: @purchase_order.prepared_by, reviewed_by: @purchase_order.reviewed_by, status: @purchase_order.status, supplier_id: @purchase_order.supplier_id, terms_payment: @purchase_order.terms_payment, total: @purchase_order.total, vat: @purchase_order.vat } }
    end
