...
class AuthorizationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post authorizations_url, params: { authorization: { costcenter: @authorization.costcenter, currency: @authorization.currency, department: @authorization.department, expense: @authorization.expense, p_grn: @authorization.p_grn, p_order: @authorization.p_order, p_request: @authorization.p_request, supplier: @authorization.supplier, user_id: @authorization.user_id } }
    end
  ...
  test "should update authorization" do
    patch authorization_url(@authorization), params: { authorization: { costcenter: @authorization.costcenter, currency: @authorization.currency, department: @authorization.department, expense: @authorization.expense, p_grn: @authorization.p_grn, p_order: @authorization.p_order, p_request: @authorization.p_request, supplier: @authorization.supplier, user_id: @authorization.user_id } }
